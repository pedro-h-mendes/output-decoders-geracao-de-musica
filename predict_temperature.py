...
def temperature_sampling (conditional_probability, temperature=1.0):
    ...
    probas = numpy.random.multinomial(1, conditional_probability, 1)
...
def generate_notes(model, network_input, pitchnames, n_vocab):
    ...
    for note_index in range(500):
        ...
        index = temperature_sampling(numpy.array(array_preds)[:,0])
...
def create_midi(prediction_output):
    ...
    midi_stream.write('midi', fp='test_output_temp.mid')
